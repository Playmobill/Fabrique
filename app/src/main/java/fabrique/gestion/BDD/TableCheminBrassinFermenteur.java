...
public class TableCheminBrassinFermenteur extends Controle  {
    ...
    /**
     * Liste des noeuds du chemin du brassin dans le fermenteur
     */
    ...
    /**
     * Fonction à utilisé pour ajouter un noeud au chemin du brassin dans le fermenteur
    ...
    /**
     * Fonction à utilisé pour modifier un noeud au chemin du brassin dans le fermenteur
    ...
    /**
     * Renvoi le premier noeud du chemin du brassin dans le fermenteur
     * en sachant que le premier noeud n'a pas de precedent
     * @return l'id du premier noeud du chemin du brassin dans le fermenteur
     */
     ...
     * @return string regroupant toutes les informations nécessaires à la sauvegarde du chemin du brassin dans le fermenteur
     */
    @Override
