...
public class DBHandler extends SQLiteOpenHelper{
    ...
    private static String createTFermenteur = "CREATE TABLE Fermenteur (id INTEGER AUTOINCREMENT PRIMARY KEY,numero INTEGER,capacite INTEGER,dateLavageAcide INTEGER,id_etatFermenteur INTEGER NOT NULL,dateEtat INTEGER,id_brassin INTEGER,id_emplacement INTEGER NOT NULL)";
