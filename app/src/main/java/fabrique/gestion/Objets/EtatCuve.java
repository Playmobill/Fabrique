...
public class EtatCuve extends Objet implements Comparable<EtatCuve> {
    ...
    public EtatCuve(long id, String texte, String historique, int couleurTexte, int couleurFond, boolean avecBrassin, boolean actif){
        super(id);
        this.texte = texte;
        this.historique = historique;
        this.couleurTexte = couleurTexte;
    ...
    @Override
    public int compareTo(@NonNull EtatCuve etat) {
