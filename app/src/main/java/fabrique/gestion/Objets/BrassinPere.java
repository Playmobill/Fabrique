...
public class BrassinPere extends Objet implements Comparable<BrassinPere> {
    ...
    //Pour un gramme de CO2 produit, il y a environ (a 3 decimales sures) 1.047 grammes d'ethanol produit.

    public BrassinPere(long id, int numero, String commentaire, long dateCreation, int quantite, long id_recette, float densiteOriginale, float densiteFinale) {
        super(id);
        this.numero = numero;
    ...
    @Override
    public int compareTo(@NonNull BrassinPere brassin) {
